...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {isDark ? <FaSun className="text-black" /> : <FaMoon className="text-black" />}
    </button>
  );
}
  ...
  return (
    <div>
      <button
        ...
        className="text-black hover:text-slate-700 flex items-center gap-2 text-sm underline"
      >
      ...
      <div className="bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full border border-white/10">
        <div className="p-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 bg-black hover:bg-slate-900 text-white font-bold py-3 px-6 rounded-lg transition-colors"
            >
              Confirm
            </button>
          </div>
    ...
    <Card title="📖 Address Book">
      <div className="mb-4">
        <button
          ...
          className="text-black hover:text-slate-700 text-sm flex items-center gap-2 underline"
        >
      ...
      {showAdd && (
        <div className="mb-4 p-4 bg-white/5 rounded-lg">
          ...
          />
          <button className="w-full bg-black hover:bg-slate-900 text-white font-bold py-2 rounded-lg">
            Save Contact
          </button>
        </div>
      )}
        ...
        <div className="space-y-2">
          {addresses.map((contact, index) => (
            <div key={index} className="bg-white/5 rounded-lg p-3 flex justify-between items-center">
              ...
              <button className="text-black hover:text-slate-700 text-sm underline">
                Use
              </button>
            </div>
          ))}
